# Compare assimilation of maqny stations with different models
...
prmsl2=DIYA.constrain_cube(prmsl,prmsl,
                           ...
                           model=sklearn.linear_model.ElasticNet(alpha=10.0,
                                                                l1_ratio=0.95),
                           lat_range=(20,85),
                           lon_range=(280,60))
...
# Output as png
fig.savefig('multi_vary_model_%04d%02d%02d%02d.png' % 
                                  (year,month,day,hour))
