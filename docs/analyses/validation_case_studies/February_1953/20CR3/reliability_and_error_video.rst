...
.. raw:: html
    ...
    <tr><td><center>On the left: MSLP Contours for 20CRv3, observations assimilated (yellow circles), DWR observations not assimilated (larger circles, coloured by deviation from reanalysis: blue - observation lower, red - observation higher). <p>Top right: Scatter plot of ensemble-observation against observation at each DWR station. <p>Bottom right: Scatter plot of ensemble standard deviation against ensemble-mean - observation.</center></td></tr>
    </table>
    </center>
